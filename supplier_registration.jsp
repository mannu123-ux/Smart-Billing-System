...
<div>
 <form action="supp_Reg"> 
	<h1 style="margin-left:150px;color:black; text-shadow:3px 3px white;">SUPPLIER REGISTRATION</h1>
	
	<table>
	<tr>
	<td><label for="id">SUPPLIER ID :</label></td>
	<td> <input type=number" id="id" name="id" placeholder="supplier id"></td>
	</tr>
	
	<tr>
	<td><label for="product_name">SUPPLIER NAME :</label></td>
	...
	<tr>
	<td><label for="add">SUPPLIER ADD. :</label></td>
	<td> <input type="textarea" id="add" name="add" placeholder="supplier add"></td>
	</tr>
